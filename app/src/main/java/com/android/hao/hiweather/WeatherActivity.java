...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //refresh to get weather data updated
    ...
    public void requestWeather(final String weatherId) {
        ...
        // Send OkHttpRequest and implement the callback function
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather != null && "ok".equals(weather.status)) {
                            ...
                            Toast.makeText(WeatherActivity.this, "load weather info failed", Toast.LENGTH_SHORT).show();
    ...
    /**
     * handle and present the data from Weather object
     *
     */
