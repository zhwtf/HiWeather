...
public class Utility {
    ...
    // Parse and handle the province data retrieved from the server
        ...
        if (!TextUtils.isEmpty(response)) {
            try {
                ...
                for (int i = 0; i < allProvinces.length(); i++) {
                    // iterate through all the provinces and extract the data
    ...
    // Parse and handle the city data retrieved from the server
    ...
    // Parse and handle the county data retrieved from the server
        ...
        if (!TextUtils.isEmpty(response)) {
            try {
                ...
                for (int i = 0; i < allCounties.length(); i++) {
                    ...
                    county.setWeatherId(countyObject.getString("weeather_id"));
